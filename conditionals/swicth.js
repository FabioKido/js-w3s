 ...
 * 
 * The break keyword is crucial for preventing a "fall-through." (Queda-livre).
...
switch (new Date().getDay()) { // If today is neither Saturday (6) nor Sunday (0), write a default message:
  case 6:
  ...
  case 0:
    ...
    break;
  default:
    text = "Looking forward to the Weekend"; // Default is not the last, break is not required.
}
...
switch (new Date().getDay()) {
  default:
    ...
    break;  // If default is not the last case in the switch block, remember to end the default case with a break.
  case 6:
    text = "Today is Saturday";
    break;
  case 0:
